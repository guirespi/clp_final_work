...
HD_PWD='C:/Users/user/CESE/clp/final_tp/synthesis/crc8_system_VIO/crc8_system_VIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crc8_system_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crc8_system_VIO.tcl
