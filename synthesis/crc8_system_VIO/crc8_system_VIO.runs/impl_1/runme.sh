...
HD_PWD='C:/Users/user/CESE/clp/final_tp/synthesis/crc8_system_VIO/crc8_system_VIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log crc8_system_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source crc8_system_VIO.tcl -notrace
